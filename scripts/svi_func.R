...
basic_demo <- function(geography, census_year) {
...
rpl1 <- function(geography, census_year, basic_demo) {
  rpl1 <- get_acs(geography = geography,
...
rpl2 <- function(geography, census_year, basic_demo) {
  ###########################################################################
  ###########################################################################
  ###                                                                     ###
  ###                           DATA COLLECTION                           ###
  ...
  rpl2 <- get_acs(geography = geography,
                  variables = c(older_65 = "S0101_C01_030",
                                ...
                                pop_5_older = "B16005_001"), year = census_year,
                  output = "wide")
...
rpl3 <- function(geography, census_year, basic_demo) {
  rpl3 <- get_acs(geography = geography,
...
rpl4 <- function(geography, census_year) {
  ...
  rpl4 <- get_acs(geography = geography,
                  variables = c(hsg_10_19_units = "DP04_0012",
                                ...
                                hsg_units_occupied = "DP04_0002"), year = census_year,
                  output = "wide")
...
svi <- function(geography, census_year) {
  ...
  rpl4 <- get_acs(geography = geography,
                  variables = c(hsg_10_19_units = "DP04_0012",
                                ...
                                hsg_crowding_2 = "DP04_0079",
                                no_autos = "DP04_0058",
                                group_quarters = "B26001_001"), year = census_year,
                  output = "wide")
